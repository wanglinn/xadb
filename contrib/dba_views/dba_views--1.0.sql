...
CREATE OR REPLACE VIEW oracle.ALL_SEQUENCES AS SELECT * FROM DBA_SEQUENCES;
DROP VIEW IF EXISTS USER_SEQUENCES CASCADE;
CREATE OR REPLACE VIEW oracle.USER_SEQUENCES AS SELECT * FROM DBA_SEQUENCES WHERE SEQUENCE_OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_TAB_COLUMNS AS SELECT * FROM DBA_TAB_COLUMNS;
DROP VIEW IF EXISTS USER_TAB_COLUMNS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TAB_COLUMNS AS SELECT * FROM DBA_TAB_COLUMNS WHERE OWNER  = UPPER(CURRENT_SCHEMA());
CREATE OR REPLACE VIEW oracle.DBA_TAB_COLS AS SELECT * FROM DBA_TAB_COLUMNS;
DROP VIEW IF EXISTS ALL_TAB_COLS CASCADE;
CREATE OR REPLACE VIEW oracle.ALL_TAB_COLS AS SELECT * FROM DBA_TAB_COLUMNS;
DROP VIEW IF EXISTS USER_TAB_COLS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TAB_COLS AS SELECT * FROM DBA_TAB_COLUMNS WHERE OWNER  = UPPER(CURRENT_SCHEMA());
CREATE OR REPLACE VIEW oracle.COLS AS SELECT * FROM DBA_TAB_COLUMNS WHERE OWNER  = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_TAB_COL_STATISTICS AS SELECT * FROM DBA_TAB_COL_STATISTICS;
DROP VIEW IF EXISTS USER_TAB_COL_STATISTICS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TAB_COL_STATISTICS AS SELECT * FROM DBA_TAB_COL_STATISTICS WHERE OWNER  = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_OBJECTS AS SELECT * FROM DBA_OBJECTS;
DROP VIEW IF EXISTS USER_OBJECTS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_OBJECTS AS SELECT * FROM DBA_OBJECTS WHERE OWNER  = UPPER(CURRENT_SCHEMA());
DROP VIEW IF EXISTS OBJ CASCADE;
CREATE OR REPLACE VIEW oracle.OBJ AS SELECT * FROM DBA_OBJECTS WHERE OWNER  = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_CATALOG AS SELECT * FROM DBA_CATALOG;
DROP VIEW IF EXISTS USER_CATALOG CASCADE;
CREATE OR REPLACE VIEW oracle.USER_CATALOG AS SELECT * FROM DBA_CATALOG WHERE OWNER  = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.DICT AS SELECT * FROM DICTIONARY;
...
CREATE OR REPLACE VIEW oracle.ALL_DEPENDENCIES AS SELECT * FROM DBA_DEPENDENCIES;
DROP VIEW IF EXISTS USER_DEPENDENCIES CASCADE;
CREATE OR REPLACE VIEW oracle.USER_DEPENDENCIES AS SELECT * FROM DBA_DEPENDENCIES WHERE OWNER  = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_SEGMENTS AS SELECT * FROM DBA_SEGMENTS;
DROP VIEW IF EXISTS USER_SEGMENTS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_SEGMENTS AS SELECT * FROM DBA_SEGMENTS WHERE OWNER  = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_SOURCE AS SELECT * FROM DBA_SOURCE;
DROP VIEW IF EXISTS USER_SOURCE CASCADE;
CREATE OR REPLACE VIEW oracle.USER_SOURCE AS SELECT * FROM DBA_SOURCE WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_PROCEDURES AS SELECT * FROM DBA_PROCEDURES;
DROP VIEW IF EXISTS USER_PROCEDURES CASCADE;
CREATE OR REPLACE VIEW oracle.USER_PROCEDURES AS SELECT * FROM DBA_PROCEDURES WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_TRIGGERS AS SELECT * FROM DBA_TRIGGERS;
DROP VIEW IF EXISTS USER_TRIGGERS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TRIGGERS AS SELECT * FROM DBA_TRIGGERS WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_TRIGGER_COLS AS SELECT * FROM DBA_TRIGGER_COLS;
DROP VIEW IF EXISTS USER_TRIGGER_COLS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TRIGGER_COLS AS SELECT * FROM DBA_TRIGGER_COLS WHERE TRIGGER_OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_TYPES AS SELECT * FROM DBA_TYPES;
DROP VIEW IF EXISTS USER_TYPES CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TYPES AS SELECT * FROM DBA_TYPES WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_CONSTRAINTS AS SELECT * FROM DBA_CONSTRAINTS;
DROP VIEW IF EXISTS USER_CONSTRAINTS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_CONSTRAINTS AS SELECT * FROM DBA_CONSTRAINTS WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_CONS_COLUMNS AS SELECT * FROM DBA_CONS_COLUMNS;
DROP VIEW IF EXISTS USER_CONS_COLUMNS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_CONS_COLUMNS AS SELECT * FROM DBA_CONS_COLUMNS WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_VIEWS AS SELECT * FROM DBA_VIEWS;
DROP VIEW IF EXISTS USER_VIEWS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_VIEWS AS SELECT * FROM DBA_VIEWS WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.DBA_ALL_TABLES AS SELECT * FROM DBA_TABLES;
DROP VIEW IF EXISTS ALL_TABLES CASCADE;
CREATE OR REPLACE VIEW oracle.ALL_TABLES AS SELECT * FROM DBA_TABLES;
DROP VIEW IF EXISTS USER_TABLES CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TABLES AS SELECT * FROM DBA_TABLES WHERE OWNER = UPPER(CURRENT_SCHEMA());
CREATE OR REPLACE VIEW oracle.TABS AS SELECT * FROM USER_TABLES;
...
CREATE OR REPLACE VIEW oracle.ALL_PART_TABLES AS SELECT * FROM DBA_PART_TABLES;
DROP VIEW IF EXISTS USER_PART_TABLES CASCADE;
CREATE OR REPLACE VIEW oracle.USER_PART_TABLES AS SELECT * FROM DBA_PART_TABLES WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_TAB_PARTITIONS AS SELECT * FROM DBA_TAB_PARTITIONS;
DROP VIEW IF EXISTS USER_TAB_PARTITIONS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TAB_PARTITIONS AS SELECT * FROM DBA_TAB_PARTITIONS WHERE TABLE_OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_TAB_STATISTICS AS SELECT * FROM DBA_TAB_STATISTICS;
DROP VIEW IF EXISTS USER_TAB_STATISTICS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TAB_STATISTICS AS SELECT * FROM DBA_TAB_STATISTICS WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_TAB_COMMENTS AS SELECT * FROM DBA_TAB_COMMENTS;
DROP VIEW IF EXISTS USER_TAB_COMMENTS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TAB_COMMENTS AS SELECT * FROM DBA_TAB_COMMENTS WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_TAB_MODIFICATIONS AS SELECT * FROM DBA_TAB_MODIFICATIONS;
DROP VIEW IF EXISTS USER_TAB_MODIFICATIONS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TAB_MODIFICATIONS AS SELECT * FROM DBA_TAB_MODIFICATIONS WHERE TABLE_OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_INDEXES AS SELECT * FROM DBA_INDEXES;
DROP VIEW IF EXISTS USER_INDEXES CASCADE;
CREATE OR REPLACE VIEW oracle.USER_INDEXES AS SELECT * FROM DBA_INDEXES WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_INDEX_USAGE AS SELECT * FROM DBA_INDEX_USAGE;
DROP VIEW IF EXISTS USER_INDEX_USAGE CASCADE;
CREATE OR REPLACE VIEW oracle.USER_INDEX_USAGE AS SELECT * FROM DBA_INDEX_USAGE WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_IND_COLUMNS AS SELECT * FROM DBA_IND_COLUMNS;
DROP VIEW IF EXISTS USER_IND_COLUMNS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_IND_COLUMNS AS SELECT * FROM DBA_IND_COLUMNS WHERE INDEX_OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_IND_PARTITIONS AS SELECT * FROM DBA_IND_PARTITIONS;
DROP VIEW IF EXISTS USER_IND_PARTITIONS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_IND_PARTITIONS AS SELECT * FROM DBA_IND_PARTITIONS WHERE INDEX_OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_IND_STATISTICS AS SELECT * FROM DBA_IND_STATISTICS;
DROP VIEW IF EXISTS USER_IND_STATISTICS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_IND_STATISTICS AS SELECT * FROM DBA_IND_STATISTICS WHERE OWNER = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_PART_INDEXES AS SELECT * FROM DBA_PART_INDEXES;
DROP VIEW IF EXISTS USER_PART_INDEXES CASCADE;
CREATE OR REPLACE VIEW oracle.USER_PART_INDEXES AS SELECT * FROM DBA_PART_INDEXES WHERE OWNER = UPPER(CURRENT_SCHEMA());


DROP VIEW IF EXISTS DBA_MVIEWS CASCADE;
CREATE OR REPLACE VIEW oracle.DBA_MVIEWS
AS
...
CREATE OR REPLACE VIEW oracle.ALL_MVIEWS AS SELECT * FROM DBA_MVIEWS;
DROP VIEW IF EXISTS USER_MVIEWS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_MVIEWS AS SELECT * FROM DBA_MVIEWS WHERE OWNER = UPPER(CURRENT_SCHEMA());


DROP VIEW IF EXISTS COLUMN_PRIVILEGES CASCADE;
CREATE OR REPLACE VIEW oracle.COLUMN_PRIVILEGES
AS
...
CREATE OR REPLACE VIEW oracle.DBA_COL_PRIVS
AS
SELECT UPPER(GRANTEE::text) as GRANTEE
     , UPPER(table_schema::text) as OWNER
     , UPPER(TABLE_NAME::text) as TABLE_NAME
...
CREATE OR REPLACE VIEW oracle.ALL_COL_PRIVS AS SELECT * FROM DBA_COL_PRIVS;
DROP VIEW IF EXISTS USER_COL_PRIVS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_COL_PRIVS AS SELECT * FROM DBA_COL_PRIVS WHERE GRANTEE = UPPER(CURRENT_SCHEMA()) OR GRANTOR = UPPER(CURRENT_SCHEMA()) OR OWNER = UPPER(CURRENT_SCHEMA());


DROP VIEW IF EXISTS DBA_CONNECT_ROLE_GRANTEES CASCADE;
CREATE OR REPLACE VIEW oracle.DBA_CONNECT_ROLE_GRANTEES
AS
...
CREATE OR REPLACE VIEW oracle.ALL_CONNECT_ROLE_GRANTEES AS SELECT * FROM DBA_CONNECT_ROLE_GRANTEES;
DROP VIEW IF EXISTS USER_CONNECT_ROLE_GRANTEES CASCADE;
CREATE OR REPLACE VIEW oracle.USER_CONNECT_ROLE_GRANTEES AS SELECT * FROM DBA_CONNECT_ROLE_GRANTEES WHERE GRANTEE = UPPER(CURRENT_SCHEMA());


DROP VIEW IF EXISTS DBA_ROLES CASCADE;
CREATE OR REPLACE VIEW oracle.DBA_ROLES
AS
...
CREATE OR REPLACE VIEW oracle.ALL_ROLES AS SELECT * FROM DBA_ROLES;


DROP VIEW IF EXISTS ROLE_TAB_PRIVS CASCADE;
CREATE OR REPLACE VIEW oracle.ROLE_TAB_PRIVS
AS
...
CREATE OR REPLACE VIEW oracle.TABLE_PRIVILEGES
AS
SELECT UPPER(GRANTEE::text) as GRANTEE
     , UPPER(table_schema::text) as OWNER
     , UPPER(table_name::text) as TABLE_NAME
...
CREATE OR REPLACE VIEW oracle.DBA_TAB_PRIVS
AS
SELECT UPPER(GRANTEE::text) as GRANTEE
     , UPPER(table_schema::text) as OWNER
     , UPPER(table_name::text) as TABLE_NAME
...
CREATE OR REPLACE VIEW oracle.ALL_TAB_PRIVS AS SELECT * FROM DBA_TAB_PRIVS;
DROP VIEW IF EXISTS USER_TAB_PRIVS CASCADE;
CREATE OR REPLACE VIEW oracle.USER_TAB_PRIVS AS SELECT * FROM DBA_TAB_PRIVS WHERE GRANTEE = UPPER(CURRENT_SCHEMA()) OR OWNER = UPPER(CURRENT_SCHEMA()) OR GRANTOR = UPPER(CURRENT_SCHEMA());
...
CREATE OR REPLACE VIEW oracle.ALL_USERS AS SELECT * FROM DBA_USERS;
