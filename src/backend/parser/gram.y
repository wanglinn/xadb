...
%type <list>	createdb_opt_list createdb_opt_items copy_opt_list
				...
				/* PGXC add pgxcnode_list pgxcnodes */
...
%type <str>		copy_file_name
				...
				/* PGXC add pgxcnode_name pgxcgroup_name */
...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	/* PGXC add DIRECT, DISTRIBUTE token */
	...
	/* added SLOT token */
	SIMILAR SIMPLE SKIP SLOT SMALLINT SNAPSHOT SOME SQL_P STABLE STANDALONE_P START
...
/* PGXC add AlterNodeStmt rule */
			...
			| AlterUserStmt
			| AnalyzeStmt
/* PGXC add BarrierStmt rule */
			| BarrierStmt
			| CheckPointStmt
/* PGXC add CleanConnStmt rule */
			| CleanConnStmt
                        | CleanSlotStmt
			| ClosePortalStmt
			| ClusterStmt
			...
			| CreateFunctionStmt
			| CreateGroupStmt
/* PGXC add CreateNodeGroupStmt, CreateNodeStmt rules */
			| CreateNodeGroupStmt
			| CreateNodeStmt
			| CreateMatViewStmt
			| CreateOpClassStmt
			...
			| DropGroupStmt
/* PGXC add DropNodeGroupStmt, DropNodeStmt rules */
			| DropNodeGroupStmt
			| DropNodeStmt
			| DropOpClassStmt
			| DropOpFamilyStmt
