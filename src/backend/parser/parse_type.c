...
TypeName *typeStringToTypeNameForGrammar(const char *str, ParseGrammar grammar)
{
...
#ifdef ADB_GRAM_ORA
		#warning TODO add ora_raw_parser(str, RAW_PARSE_TYPE_NAME)
		ereport(ERROR,
				errcode(ERRCODE_FEATURE_NOT_SUPPORTED),
				errmsg("neeed function ora_raw_parser(str, RAW_PARSE_TYPE_NAME)"));
	...
	case PARSE_GRAM_DB2:
#ifdef ADB_GRAM_DB2
		#warning TODO add db2_raw_parser(str, RAW_PARSE_TYPE_NAME)
		ereport(ERROR,
				errcode(ERRCODE_FEATURE_NOT_SUPPORTED),
				errmsg("neeed function db2_raw_parser(str, RAW_PARSE_TYPE_NAME)"));
