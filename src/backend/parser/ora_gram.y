...
%token <keyword> ABSOLUTE_P ACCESS ADD_P AGGREGATE ALL ALTER ANALYZE ANALYSE AND ABORT_P
	...
	SCHEMA SECOND_P SELECT SERIALIZABLE SERVER SESSION SESSIONTIMEZONE SET SETS SHARE SHOW SIZE SEARCH
	SMALLINT SIMPLE SETOF SUBSCRIPTION STATISTICS SAVEPOINT SEQUENCE SYSID SOME SCROLL
