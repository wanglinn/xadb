 ...
 * at the Coordinator
 */
static const FormData_pg_attribute a_xc_node_id = {
	.attname = {"xc_node_id"},
	.atttypid = INT4OID,
	.attlen = sizeof(int32),
...
static const FormData_pg_attribute a_infomask = {
	.attname = {"infomask"},
	.atttypid = INT2OID,
	.attlen = sizeof(int16),
	.attnum = ADB_InfoMaskAttributeNumber,
	.attcacheoff = -1,
	.atttypmod = -1,
	.attbyval = true,
	.attstorage = 'p',
			...
			char attgenerated)
{
	...
	if (attgenerated)
	{
		...
		if (attgenerated &&
			expr != NULL &&
			IsA(expr, FuncExpr) &&
			((FuncExpr*)expr)->funcid == F_ORACLE_NEXTROWID &&
