...
CREATE CAST (oracle.rid AS varchar2) WITH INOUT AS IMPLICIT;

CREATE CAST (varchar2 AS oracle.rid) WITH INOUT AS IMPLICIT;

CREATE CAST (oracle.rid AS nvarchar2) WITH INOUT AS IMPLICIT;

CREATE CAST (nvarchar2 AS oracle.rid) WITH INOUT AS IMPLICIT;
