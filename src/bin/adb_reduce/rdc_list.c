 ...
 *
 * rdc_list.c
 *	  implementation for Reduce generic linked list package
 *
 *
 * Portions Copyright (c) 2016-2017, ADB Development Group
 *
 * IDENTIFICATION
 *	  src/bin/adb_reduce/rdc_list.c
 *
 *-------------------------------------------------------------------------
 */
 ...
 */
#define IsPointerList(l)		((l) == NIL || ((List *)(l))->type == R_List)
#define IsIntegerList(l)		((l) == NIL || ((List *)(l))->type == R_IntList)
#define IsOidList(l)			((l) == NIL || ((List *)(l))->type == R_OidList)
