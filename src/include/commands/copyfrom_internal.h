...
#define RAW_BUF_BYTES(cstate) ((cstate)->raw_buf_len - (cstate)->raw_buf_index)
	...
	struct BufFile	   *fd_copied_ctid;	/* saved tuple(s) ctid */
...
#ifdef ADB
uint64 CoordinatorCopyFrom(CopyFromState cstate);
TupleTableSlot* NextRowFromCoordinator(CopyFromState cstate, ExprContext *econtext, void *data);
#endif /* ADB */
