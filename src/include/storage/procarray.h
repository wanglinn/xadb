...
extern void ProcArrayEndTransaction(PGPROC *proc, TransactionId latestXid ADB_ONLY_COMMA_ARG(bool isCommit));
...
extern List *GetAllSnapRcvAssginXids(void);
...
extern TransactionId GetOldestXminExt(Relation rel, int flags, bool is_snap_sync);
#endif /* ADB */
