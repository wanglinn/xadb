...
BEGIN_ENUM(AlterSubscriptionType)
	...
	ENUM_VALUE(ALTER_SUBSCRIPTION_SET_PUBLICATION)
	ENUM_VALUE(ALTER_SUBSCRIPTION_ADD_PUBLICATION)
	ENUM_VALUE(ALTER_SUBSCRIPTION_DROP_PUBLICATION)
...
BEGIN_ENUM(AlterTableType)
	...
	ENUM_VALUE(AT_CookedColumnDefault)
...
BEGIN_ENUM(NodeTag)
	...
	ENUM_VALUE(T_TidRangeScanState)
	...
	ENUM_VALUE(T_RowIdentityVarInfo)
	...
	ENUM_VALUE(T_ReturnStmt)
	ENUM_VALUE(T_PLAssignStmt)
	...
	ENUM_VALUE(T_CTESearchClause)
	ENUM_VALUE(T_CTECycleClause)
...
#ifdef ADB_GRAM_ORA
	ENUM_VALUE(OBJECT_ORACLE_CAST)
	ENUM_VALUE(OBJECT_ORACLE_CONVERT)
#endif
#ifdef ADB
...
BEGIN_ENUM(RoleSpecType)
	...
	ENUM_VALUE(ROLESPEC_CURRENT_ROLE)
...
#ifndef NO_ENUM_SetQuantifier
BEGIN_ENUM(SetQuantifier)
	ENUM_VALUE(SET_QUANTIFIER_DEFAULT)
	ENUM_VALUE(SET_QUANTIFIER_ALL)
	ENUM_VALUE(SET_QUANTIFIER_DISTINCT)
END_ENUM(SetQuantifier)
#endif /* NO_ENUM_SetQuantifier */
...
#ifndef NO_ENUM_StdRdOptIndexCleanup
BEGIN_ENUM(StdRdOptIndexCleanup)
	ENUM_VALUE(STDRD_OPTION_VACUUM_INDEX_CLEANUP_AUTO)
	ENUM_VALUE(STDRD_OPTION_VACUUM_INDEX_CLEANUP_OFF)
	ENUM_VALUE(STDRD_OPTION_VACUUM_INDEX_CLEANUP_ON)
END_ENUM(StdRdOptIndexCleanup)
#endif /* NO_ENUM_StdRdOptIndexCleanup */
...
BEGIN_ENUM(TableLikeOption)
	...
	ENUM_VALUE(CREATE_TABLE_LIKE_COMPRESSION)
...
#ifndef NO_ENUM_VolatileFunctionStatus
BEGIN_ENUM(VolatileFunctionStatus)
	ENUM_VALUE(VOLATILITY_UNKNOWN)
	ENUM_VALUE(VOLATILITY_VOLATILE)
	ENUM_VALUE(VOLATILITY_NOVOLATILE)
END_ENUM(VolatileFunctionStatus)
#endif /* NO_ENUM_VolatileFunctionStatus */
