...
#define list_make5_int(x1,x2,x3,x4,x5) \
	list_make5_impl(T_IntList, list_make_int_cell(x1),						\
					list_make_int_cell(x2), list_make_int_cell(x3),			\
					list_make_int_cell(x4), list_make_int_cell(x5))
...
#define list_make5_oid(x1,x2,x3,x4,x5) \
	list_make5_impl(T_OidList, list_make_oid_cell(x1),						\
					list_make_oid_cell(x2), list_make_oid_cell(x3),			\
					list_make_oid_cell(x4), list_make_oid_cell(x5))
...
extern List *list_make5_impl(NodeTag t, ListCell datum1,
							 ListCell datum2, ListCell datum3,
							 ListCell datum4, ListCell datum5);
