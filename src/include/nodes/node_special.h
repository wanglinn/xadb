...
NODE_SPECIAL_MEB(Group)
	...
	grpCollations NODE_SCALAR_POINT(Oid,grpCollations,NODE_ARG_->numCols)
...
NODE_SPECIAL_MEB(WindowAgg)
	...
	partCollations NODE_SCALAR_POINT(Oid,partCollations,NODE_ARG_->partNumCols)
	...
	ordCollations NODE_SCALAR_POINT(Oid,ordCollations,NODE_ARG_->ordNumCols)
...
NODE_SPECIAL_MEB(Unique)
	...
	uniqCollations NODE_SCALAR_POINT(Oid,uniqCollations,NODE_ARG_->numCols)
...
NODE_SPECIAL_MEB(PartitionedRelPruneInfo)
	...
	subplan_map NODE_SCALAR_POINT(int,subplan_map,NODE_ARG_->nparts)
	subpart_map NODE_SCALAR_POINT(int,subpart_map,NODE_ARG_->nparts)
	relid_map NODE_SCALAR_POINT(Oid,relid_map,NODE_ARG_->nparts)
...
IDENT_IF_DEFINED(ReduceKeyInfo, ADB)

IDENT_IF_DEFINED(RelationLocInfo, ADB)
IDENT_IF_DEFINED(ReduceInfo, ADB)
IDENT_IF_DEFINED(IConvertAction, ADB_GRAM_ORA)
IDENT_IF_DEFINED(PackageAction, ADB_GRAM_ORA)