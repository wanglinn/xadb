 ...
 * ----------------
 */
#define OraCastRelationId	5008

CATALOG(ora_cast,5008)
{
...
DATA(insert (	25		9009	5381	5381	d	));						/* text -> oracle.date */
...
DATA(insert (	1043	9009	5381	5381	d	));						/* varchar -> oracle.date */
...
DATA(insert (	4001	9009	5381	5381	d	));						/* varchar2 -> oracle.date */
...
DATA(insert (	4003	9009	5381	5381	d	));						/* nvarchar2 -> oracle.date */
...
DATA(insert (	1042	9009	5381	5381	d	));						/* bpchar -> oracle.date */
