...
DATA(insert OID = 4012 (  monitor_handle_gtm       PGNSP PGUID 12 10 400 0 0 f f f f t t s s 4 0 2249 "16 23 23 2275" "{19,16,25}" "{o,o,o}" "{nodename,status,description}" _null_ _null_ monitor_handle_gtm _null_ _null_ _null_ ));
