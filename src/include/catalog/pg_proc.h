...
DATA(insert OID = 9019 ( nodeid_from_hashvalue		PGNSP PGUID 12 1 0 0 0 f f f f f f v s 1 0 20 "23" _null_ _null_ _null_ _null_ _null_ nodeid_from_hashvalue _null_ _null_ _null_ ));
...
DATA(insert OID = 4820 ( pg_alter_node       PGNSP PGUID 12 1 0 0 0 f f f f t f v s 5 0 16 "2275 2275 2275 23 16" _null_ _null_ _null_ _null_ _null_ pg_alter_node _null_ _null_ _null_ ));
DESCR("alter node");
...
/* oracle replace */
DATA(insert OID =  5403 ( replace				ORANSP PGUID 12 1 0 0 0 f f f f f f i s 3 0 25 "25 25 25" _null_ _null_ _null_ _null_ _null_	ora_replace_text _null_ _null_ _null_ ));
...
DATA(insert OID = 4014 (  monitor_handle_gtm       PGNSP PGUID 12 10 400 2276 0 f f f f t t s s 1 0 2249 "2275 16 23 23 23" "{19,16,25}" "{o,o,o}" "{nodename,status,description}" _null_ _null_ monitor_handle_gtm _null_ _null_ _null_ ));
DESCR("monitor auto handle gtm master");

DATA(insert OID = 4099 (  monitor_handle_datanode       PGNSP PGUID 12 10 400 0 0 f f f f t t s s 0 0 2249 "" "{19,16,25}" "{o,o,o}" "{nodename,status,description}" _null_ _null_ monitor_handle_datanode _null_ _null_ _null_ ));
DESCR("monitor auto handle datanode master");

DATA(insert OID = 4100 (  monitor_handle_gtm       PGNSP PGUID 12 10 400 0 0 f f f f t t s s 0 0 2249 "" "{19,16,25}" "{o,o,o}" "{nodename,status,description}" _null_ _null_ monitor_handle_gtm _null_ _null_ _null_ ));
DESCR("monitor auto handle gtm master");
