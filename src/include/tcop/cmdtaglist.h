...
#ifdef ADB_GRAM_ORA
PG_CMDTAG(CMDTAG_ORACLE_CREATE_CAST, "CREATE ORACLE CAST", false, false, false)
PG_CMDTAG(CMDTAG_ORACLE_CREATE_CONVERT, "CREATE CONVERT", false, false, false)
PG_CMDTAG(CMDTAG_ORACLE_DROP_CAST, "DROP CAST", false, false, false)
PG_CMDTAG(CMDTAG_ORACLE_DROP_CONVERT, "DROP CONVERT", false, false, false)
PG_CMDTAG(CMDTAG_ORACLE_PACKAGE_CREATE, "CREATE PACKAGE", true, false, false)
PG_CMDTAG(CMDTAG_ORACLE_PACKAGE_CREATE_BODY, "CREATE PACKAGE BODY", true, false, false)
PG_CMDTAG(CMDTAG_ORACLE_PACKAGE_DROP, "DROP PACKAGE", true, false, false)
PG_CMDTAG(CMDTAG_ORACLE_PACKAGE_DROP_BODY, "DROP PACKAGE BODY", true, false, false)
#endif /* ADB_GRAM_ORA */
#ifdef ADB
PG_CMDTAG(CMDTAG_AGTM_LISTEN_PORT, "AGTM LISTEN PORT", false, false, false)
PG_CMDTAG(CMDTAG_ALTER_NODE, "ALTER NODE", false, false, false)
PG_CMDTAG(CMDTAG_BARRIER, "BARRIER", false, false, false)
PG_CMDTAG(CMDTAG_CLEAN_CONNECTION, "CLEAN CONNECTION", false, false, false)
PG_CMDTAG(CMDTAG_CREATE_AUXILIARY_TABLE, "CREATE AUXILIARY TABLE", true, false, false)
PG_CMDTAG(CMDTAG_CREATE_GROUP, "CREATE NODE GROUP", false, false, false)
PG_CMDTAG(CMDTAG_CREATE_NODE, "CREATE NODE", false, false, false)
PG_CMDTAG(CMDTAG_DROP_AUXILIARY_TABLE, "DROP AUXILIARY TABLE", true, false, false)
PG_CMDTAG(CMDTAG_DROP_GROUP, "DROP NODE GROUP", false, false, false)
PG_CMDTAG(CMDTAG_DROP_NODE, "DROP NODE", false, false, false)
PG_CMDTAG(CMDTAG_EXEC_DIRECT, "EXECUTE DIRECT", false, false, false)
PG_CMDTAG(CMDTAG_FINISH_ACTIVE_BACKEND, "FINISH BACKEND", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_GET_GXID, "GTM GET GXID", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_GET_TIMESTAMP, "GTM GET TIMESTAMP", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_GXID_LIST, "GTM GXID LIST", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SNAPSHOT_GET, "GTM SNAPSHOT GET", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_GET_XACT_STATUS, "GTM GET XACT STATUS", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SYNC_XID, "GTM SYNC XID", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_INIT, "GTM SEQUENCE INIT", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_ALTER, "GTM SEQUENCE ALTER", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_DROP, "GTM SEQUENCE DROP", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_DROP_BYDB, "GTM SEQUENCE DROP BYDB", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_RENAME, "GTM SEQUENCE RENAME", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_RENAME_BYDB, "GTM SEQUENCE RENAME BYDB", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_GET_NEXT, "GTM SEQUENCE GET NEXT", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_GET_CUR, "GTM SEQUENCE GET CUR", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_GET_LAST, "GTM SEQUENCE GET LAST", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_SET_VAL, "GTM SEQUENCE SET VAL", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_SEQUENCE_RESET_CACHE, "GTM SEQUENCE RESET CACHE", false, false, false)
PG_CMDTAG(CMDTAG_AGTM_GET_STATUS, "GTM GET STATUS", false, false, false)
#endif /* ADB */
#ifdef ADBMGRD
PG_CMDTAG(CMDTAG_MGR_ADD_HOST, "ADD HOST", false, false, false)
PG_CMDTAG(CMDTAG_MGR_DROP_HOST, "DROP HOST", false, false, false)
PG_CMDTAG(CMDTAG_MGR_ALTER_HOST, "ALTER HOST", false, false, false)
PG_CMDTAG(CMDTAG_MGR_ADD_NODE, "ADD NODE", false, false, false)
PG_CMDTAG(CMDTAG_MGR_DROP_NODE, "DROP NODE", false, false, false)
PG_CMDTAG(CMDTAG_MGR_ALTER_NODE, "ALTER NODE", false, false, false)
PG_CMDTAG(CMDTAG_MGR_SET_PARAM, "SET PARAM", false, false, false)
PG_CMDTAG(CMDTAG_MGR_RESET_PARAM, "RESET PARAM", false, false, false)
PG_CMDTAG(CMDTAG_MGR_START_AGENT, "START AGENT", false, false, false)
PG_CMDTAG(CMDTAG_MGR_FLUSH_HOST, "FLUSH HOST", false, false, false)
PG_CMDTAG(CMDTAG_MGR_SET_DOCTOR, "SET DOCTOR", false, false, false)
PG_CMDTAG(CMDTAG_MGR_ADD_ITEM, "ADD ITEM", false, false, false)
PG_CMDTAG(CMDTAG_MGR_ALTER_ITEM, "ALTER ITEM", false, false, false)
PG_CMDTAG(CMDTAG_MGR_DROP_ITEM, "DROP ITEM", false, false, false)
PG_CMDTAG(CMDTAG_MGR_ADD_JOB, "ADD JOB", false, false, false)
PG_CMDTAG(CMDTAG_MGR_ALTER_JOB, "ALTER JOB", false, false, false)
PG_CMDTAG(CMDTAG_MGR_DROP_JOB, "DROP JOB", false, false, false)
PG_CMDTAG(CMDTAG_MGR_ADD_EXTENSION, "ADD EXTENSION", false, false, false)
PG_CMDTAG(CMDTAG_MGR_DROP_EXTENSION, "DROP EXTENSION", false, false, false)
PG_CMDTAG(CMDTAG_MGR_REMOVE_NODE, "REMOVE NODE", false, false, false)
PG_CMDTAG(CMDTAG_MGR_SET_CLUSTER_INIT, "SET CLUSTER INIT", false, false, false)
PG_CMDTAG(CMDTAG_MGR_CLEAN_MONITOR_DATA, "CLEAN MONITOR DATA", false, false, false)
PG_CMDTAG(CMDTAG_MGR_FLUSH_PARAM, "FLUSH PARAM", false, false, false)
PG_CMDTAG(CMDTAG_MGR_FLUSH_READONLY_SLAVE, "FLUSH READONLY SLAVE", false, false, false)
#endif /* ADBMGRD */
