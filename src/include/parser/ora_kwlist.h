...
PG_KEYWORD("block", BLOCK, UNRESERVED_KEYWORD)
PG_KEYWORD("body", BODY, UNRESERVED_KEYWORD)
...
PG_KEYWORD("common", COMMON, UNRESERVED_KEYWORD)
PG_KEYWORD("compress", COMPRESS, RESERVED_KEYWORD)
PG_KEYWORD("concurrently", CONCURRENTLY, TYPE_FUNC_NAME_KEYWORD)
//PG_KEYWORD("configuration", CONFIGURATION, UNRESERVED_KEYWORD)
PG_KEYWORD("connect", CONNECT, UNRESERVED_KEYWORD)
/* CONNECT_BY_ROOT is an operator in oracle, here we let it as reserved keyword */
...
PG_KEYWORD("convert", CONVERT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("editionable", EDITIONABLE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("noneditionable", NONEDITIONABLE, COL_NAME_KEYWORD)
...
PG_KEYWORD("record", RECORD, UNRESERVED_KEYWORD)
...
PG_KEYWORD("sample", SAMPLE, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("seed", SEED, UNRESERVED_KEYWORD)
...
PG_KEYWORD("special", SPECIAL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("wait", WAIT, RESERVED_KEYWORD)
