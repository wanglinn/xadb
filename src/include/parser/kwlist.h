...
#ifdef ADB
PG_KEYWORD("auxiliary", AUXILIARY, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("backend", BACKEND, UNRESERVED_KEYWORD, BARE_LABEL)
#endif
PG_KEYWORD("backward", BACKWARD, UNRESERVED_KEYWORD, BARE_LABEL)
#ifdef ADB
PG_KEYWORD("barrier", BARRIER, UNRESERVED_KEYWORD, BARE_LABEL)
#endif
...
#ifdef ADB
PG_KEYWORD("clean", CLEAN, UNRESERVED_KEYWORD, BARE_LABEL)
#endif
...
#ifdef ADB
PG_KEYWORD("direct", DIRECT, UNRESERVED_KEYWORD, BARE_LABEL)
#endif /* ADB */
...
#ifdef ADB
PG_KEYWORD("distribute", DISTRIBUTE, UNRESERVED_KEYWORD, BARE_LABEL)
#endif
...
#ifdef ADB
PG_KEYWORD("finish", FINISH, UNRESERVED_KEYWORD, BARE_LABEL)
#endif /* ADB */
...
#ifdef ADB
PG_KEYWORD("preferred", PREFERRED, UNRESERVED_KEYWORD, BARE_LABEL)
#endif /* ADB */
...
#ifdef ADB
PG_KEYWORD("slave", SLAVE, UNRESERVED_KEYWORD, BARE_LABEL)
#endif
