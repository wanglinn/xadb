...
#ifdef ADB
PG_KEYWORD("auxiliary", AUXILIARY, UNRESERVED_KEYWORD)
PG_KEYWORD("backend", BACKEND, UNRESERVED_KEYWORD)
#endif
...
#ifdef ADB
PG_KEYWORD("finish", FINISH, UNRESERVED_KEYWORD)
#endif /* ADB */
...
PG_KEYWORD("oracle", ORACLE, UNRESERVED_KEYWORD) /* ADB_GRAM_ORA */
