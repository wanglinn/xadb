...
PG_KEYWORD("activate", ACTIVATE, UNRESERVED_KEYWORD)
PG_KEYWORD("adbmgr", ADBMGR, UNRESERVED_KEYWORD)
...
PG_KEYWORD("basebackup", BASEBACKUP, UNRESERVED_KEYWORD)
PG_KEYWORD("boottime", BOOTTIME, UNRESERVED_KEYWORD)
PG_KEYWORD("check", DOCHECK, UNRESERVED_KEYWORD)
PG_KEYWORD("check_password", CHECK_PASSWORD, UNRESERVED_KEYWORD)
PG_KEYWORD("check_user", CHECK_USER, UNRESERVED_KEYWORD)
PG_KEYWORD("checkout", CHECKOUT, UNRESERVED_KEYWORD)
PG_KEYWORD("clean", CLEAN, UNRESERVED_KEYWORD)
PG_KEYWORD("clear", CLEAR, UNRESERVED_KEYWORD)
...
PG_KEYWORD("data_checksums", DATA_CHECKSUMS, UNRESERVED_KEYWORD)
PG_KEYWORD("datanode", DATANODE, RESERVED_KEYWORD)
PG_KEYWORD("deploy", DEPLOY, UNRESERVED_KEYWORD)
PG_KEYWORD("doctor", DOCTOR, UNRESERVED_KEYWORD)
PG_KEYWORD("dopromote", DOPROMOTE, UNRESERVED_KEYWORD)
PG_KEYWORD("drop", DROP, UNRESERVED_KEYWORD)
PG_KEYWORD("end", END, UNRESERVED_KEYWORD)
PG_KEYWORD("exists", EXISTS, UNRESERVED_KEYWORD)
PG_KEYWORD("expand", EXPAND, UNRESERVED_KEYWORD)
PG_KEYWORD("extension", EXTENSION, UNRESERVED_KEYWORD)
PG_KEYWORD("f", F, UNRESERVED_KEYWORD)
PG_KEYWORD("fail", FAIL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("for", FOR, UNRESERVED_KEYWORD)
...
PG_KEYWORD("get_cluster_connect_dbsize_indexsize", GET_CLUSTER_CONNECT_DBSIZE_INDEXSIZE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("get_cluster_tps_qps", GET_CLUSTER_TPS_QPS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("gtmcoord", GTMCOORD, UNRESERVED_KEYWORD)
...
PG_KEYWORD("master", MASTER, RESERVED_KEYWORD)
PG_KEYWORD("maxvalue", MAXVALUE, UNRESERVED_KEYWORD)
PG_KEYWORD("meta", META, UNRESERVED_KEYWORD)
...
PG_KEYWORD("pgxcnode", PGXCNODE, UNRESERVED_KEYWORD)
PG_KEYWORD("pretty", PRETTY, UNRESERVED_KEYWORD)
PG_KEYWORD("promote", PROMOTE, UNRESERVED_KEYWORD)
PG_KEYWORD("readonly", READONLY, UNRESERVED_KEYWORD)
PG_KEYWORD("recover", RECOVER, UNRESERVED_KEYWORD)
...
PG_KEYWORD("rewind", REWIND, UNRESERVED_KEYWORD)
...
PG_KEYWORD("slave", SLAVE, RESERVED_KEYWORD)
PG_KEYWORD("sleep", SLEEP, UNRESERVED_KEYWORD)
PG_KEYWORD("slink", SLINK, UNRESERVED_KEYWORD)
...
PG_KEYWORD("status", STATUS, RESERVED_KEYWORD)
PG_KEYWORD("stop", STOP, UNRESERVED_KEYWORD)
PG_KEYWORD("success", SUCCESS, UNRESERVED_KEYWORD)
PG_KEYWORD("switchover", SWITCHOVER, UNRESERVED_KEYWORD)
...
PG_KEYWORD("with", WITH, UNRESERVED_KEYWORD)
