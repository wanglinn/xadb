...
/* encode.c */
#ifdef ADB_GRAM_ORA
extern uint64 pg_base64_encode(const char *src, size_t srclen, char *dst, size_t dstlen);
extern uint64 pg_base64_decode(const char *src, size_t srclen, char *dst, size_t dstlen);
#endif
