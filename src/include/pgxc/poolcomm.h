...
extern int	pool_listen(void);
extern int	pool_connect(void);
...
extern int	pool_sendfds(const int fdsock, pgsocket *fds, int count);
extern int	pool_recvfds(const int fdsock, pgsocket *fds, int count);
...
extern const char* pool_get_sock_path(void);
