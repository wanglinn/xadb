...
{
	 AGT_CMD_GTMCOOR_INIT = 1
	,AGT_CMD_GTMCOOR_SLAVE_INIT
	,AGT_CMD_GTMCOOR_START_MASTER
	,AGT_CMD_GTMCOOR_START_SLAVE
	,AGT_CMD_GTMCOOR_STOP_MASTER
	,AGT_CMD_GTMCOOR_STOP_SLAVE
	,AGT_CMD_GTMCOOR_CLEAN
	,AGT_CMD_GTMCOOR_SLAVE_FAILOVER
	...
	,AGT_CMD_GTMCOOR_STOP_MASTER_BACKEND
