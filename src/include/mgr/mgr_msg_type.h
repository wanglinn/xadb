...
#define HBA_CONFIG_SEPARATOR  	"#DONOT REMOVE THIS LINE"
/* command type */
...
typedef enum AgentCommand
{
	...
	,AGT_CMD_CNDN_ADD_PGHBACONF_TAIL
	,AGT_CMD_CNDN_ADD_PGHBACONF_SEPARATOR
}AgentCommand;

/* Warnning:  AgentCommand has been used by DBOPS, so the AgentCommand only add by the tail  */
