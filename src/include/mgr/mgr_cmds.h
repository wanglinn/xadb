...
extern void mgr_append_pgconf_paras_str_quotastr(const char *key, const char *value, StringInfo infosendmsg);
...
extern bool mgr_check_agent_running(Oid hostOid);
...
extern void add_seprator_to_hba_file(void);
...
extern void MgrZoneSwitchoverCoord(MemoryContext spiContext, char *currentZone, bool forceSwitch, int maxTrys, ZoneOverGtm *zoGtm, dlist_head *zoCoordList);
extern void MgrZoneSwitchoverDataNode(MemoryContext spiContext, char *currentZone, bool forceSwitch, int maxTrys, ZoneOverGtm *zoGtm, dlist_head *zoDNList);
