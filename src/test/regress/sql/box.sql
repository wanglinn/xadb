...
SELECT * FROM box_temp WHERE f1 << '(10,20),(30,40)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 << '(10,20),(30,40)';

SELECT * FROM box_temp WHERE f1 &< '(10,4.333334),(5,100)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 &< '(10,4.333334),(5,100)';

SELECT * FROM box_temp WHERE f1 && '(15,20),(25,30)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 && '(15,20),(25,30)';

SELECT * FROM box_temp WHERE f1 &> '(40,30),(45,50)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 &> '(40,30),(45,50)';

SELECT * FROM box_temp WHERE f1 >> '(30,40),(40,30)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 >> '(30,40),(40,30)';

SELECT * FROM box_temp WHERE f1 <<| '(10,4.33334),(5,100)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 <<| '(10,4.33334),(5,100)';

SELECT * FROM box_temp WHERE f1 &<| '(10,4.3333334),(5,1)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 &<| '(10,4.3333334),(5,1)';

SELECT * FROM box_temp WHERE f1 |&> '(49.99,49.99),(49.99,49.99)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 |&> '(49.99,49.99),(49.99,49.99)';

SELECT * FROM box_temp WHERE f1 |>> '(37,38),(39,40)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 |>> '(37,38),(39,40)';

SELECT * FROM box_temp WHERE f1 @> '(10,11),(15,16)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 @> '(10,11),(15,15)';

SELECT * FROM box_temp WHERE f1 <@ '(10,15),(30,35)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
EXPLAIN (COSTS OFF) SELECT * FROM box_temp WHERE f1 <@ '(10,15),(30,35)';

SELECT * FROM box_temp WHERE f1 ~= '(20,20),(40,40)' order by (f1[0])[0],(f1[0])[0],(f1[1])[0],(f1[1])[1];
