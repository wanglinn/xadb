...
select 1+to_char(1) from dual;
create table t4test(id number,name varchar2(3),ad char(3));
insert into t4test values(1,'1.0','1');
select 1+name from t4test;
select 1+ad from t4test;
drop table t4test;
...
select 1/'1'::char(3) from dual;
--比较运算符	
create table t4test(id number, name varchar2(3));
insert into t4test values(1,'1.0');
select * from t4test where name = 1;
drop table t4test;
...
create table t4test(id number,job varchar(10));
insert into t4test values(1,'IT');
insert into t4test values(2,'doctor');
insert into t4test values(3,'teacher');
insert into t4test values(6,'');
create table aa(id char,avgm number);
insert into aa values(1.00,10000);
insert into aa values(2,5000);
insert into aa values(4,9000);
insert into aa values(5,null);
select * from t4test where id > all(select id from aa);
drop table t4test;
drop table aa;
--between and		
