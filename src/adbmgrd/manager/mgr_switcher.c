							   ...
							   bool kickOutOldMaster)
{
	...
	refreshGtmInfoOnNodes(newMaster->mgrNode, coordinators, newMaster);
	...
	refreshGtmInfoOnNodes(newMaster->mgrNode, dataNodes, newMaster);
