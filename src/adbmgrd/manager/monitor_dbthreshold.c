...
static void  mthreshold_sqlvaluesfrom_dnmaster(void)
{
	...
	while((hosttuple = heap_getnext(hostrel_scan, ForwardScanDirection)) != NULL)
	{
		...
		noderel_scan = heap_beginscan_catalog(noderel, 1, key);
		phynodeheaphit = 0;
		phynodeheapread = 0;
...
static void  mthreshold_sqlvaluesfrom_coord(void)
{
	...
	Oid hostoid;
	ScanKeyData key[1];
	int64 phynodecommit = 0;
	int64 clustercommit = 0;
	int64 phynoderollback = 0;
	int64 clusterrollback = 0;
	int64 phynodecommitrate = 100;
	int64 clustercommitrate = 100;
	int64 phynodelocks = 0;
	int64 clusterlocks = 0;
	int64 phynodelongtrans = 0;
	int64 phynodeidletrans = 0;
	int64 clusterlongtrans = 0;
	int64 clusteridletrans = 0;
	int64 phynodeconnect = 0;
	int64 clusterconnect = 0;
	int port = 0;
	int len = 6;
	int64 iarray[6] = {0,0,0,0,0,0};
	int agentport = 0;
	NameData ndatauser;
	char *address;
